...
public class PublicChannelNameValidator extends Validator<String, String> {
    ...
    public String validate(String data) throws ValidationError {
        ...
        if (channelName.length() < minLength)
            throw new ValidationError("the length of channelName is at least " + PublicChannelNameValidator.minLength + " !");
        if (channelName.length() > maxLength)
            throw new ValidationError("the length of channelName is at most " + PublicChannelNameValidator.maxLength + " !");
