...
public class PageRequestValidator implements Validator<PageRequest, org.springframework.data.domain.PageRequest> {
    ...
    @Override
    public org.springframework.data.domain.PageRequest validate(PageRequest data) throws ValidationError {
