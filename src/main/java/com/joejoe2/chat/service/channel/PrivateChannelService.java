...
public interface PrivateChannelService {
     ...
     */
    PrivateChannelProfile createChannelBetween(String fromUserId, String toUserId) throws AlreadyExist, UserDoesNotExist, InvalidOperation;
     ...
     * @throws UserDoesNotExist
     */
    SliceList<PrivateChannelProfile> getAllChannels(String ofUserId, PageRequest pageRequest) throws UserDoesNotExist;
     ...
     */
    PrivateChannelProfile getChannelProfile(String ofUserId, String channelId) throws UserDoesNotExist, ChannelDoesNotExist, InvalidOperation;
}
