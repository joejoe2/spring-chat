...
public interface PrivateMessageService {
  ...
  SliceList<PrivateMessageDto> getAllMessages(String userId, PageRequest pageRequest)
      throws UserDoesNotExist;

  SliceList<PrivateMessageDto> getAllMessages(
      String userId, String channelId, PageRequest pageRequest)
      throws UserDoesNotExist, ChannelDoesNotExist, InvalidOperation;

  SliceList<PrivateMessageDto> getAllMessages(String userId, Instant since, PageRequest pageRequest)
      throws UserDoesNotExist;
