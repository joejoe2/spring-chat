...
class PublicMessageServiceTest {
    ...
    void getAllMessages() throws Exception{
        ...
        assertEquals(messages.subList(20, 30), sliceList.getList().stream().map(PublicMessageDto::getContent).toList());
    }
    ...
    void getMessagesSince() throws Exception{
        ...
        assertEquals(10, sliceList.getPageSize());
        assertEquals(messages.subList(10, 20), sliceList.getList().stream().map(PublicMessageDto::getContent).toList());
    }
}