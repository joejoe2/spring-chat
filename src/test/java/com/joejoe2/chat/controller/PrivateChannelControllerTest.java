...
class PrivateChannelControllerTest {
    ...
    void publishMessage() throws Exception {
        ...
        PublishPrivateMessageRequest request = PublishPrivateMessageRequest
                .builder().channelId(channel.getId().toString()).message("msg")
                .build();
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/api/channel/private/publishMessage")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request))
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();

        PrivateMessageDto message = objectMapper.readValue(result.getResponse().getContentAsString(), PrivateMessageDto.class);
        PrivateMessageDto message1 = messageService.getAllMessages(user1.getId().toString(), PageRequest.builder().page(0).size(1).build()).getList().get(0);
        PrivateMessageDto message2 = messageService.getAllMessages(user2.getId().toString(), PageRequest.builder().page(0).size(1).build()).getList().get(0);
    ...
    void publishMessageWithError() throws Exception {
        PublishPrivateMessageRequest request = PublishPrivateMessageRequest
                .builder().channelId("invalid id").message(" ")
                .build();
        //test 400
        mockMvc.perform(MockMvcRequestBuilders.post("/api/channel/private/publishMessage")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request))
                        .accept(MediaType.APPLICATION_JSON))
        ...
        request = PublishPrivateMessageRequest
    ...
    void getMessages() throws Exception {
        ...
        for (int i = 0; i < 10; i++)
            messages.add(messageService.createMessage(user1.getId().toString(), channel.getId().toString(), "msg"));
        ...
        //test success
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/getAllMessages")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
    ...
    void getMessagesWithError() throws Exception {
        ...
        query.add("page", request.getPage().toString());
        query.add("size", request.getSize().toString());
        mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/getAllMessages")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void getMessagesSince() throws Exception {
        ...
        for (int i = 0; i < 10; i++)
            messages.add(messageService.createMessage(user1.getId().toString(), channel.getId().toString(), "msg"));
        //test success
        GetPrivateMessageSinceRequest request = GetPrivateMessageSinceRequest
                .builder().since(since).pageRequest(PageRequest.builder().page(0).size(messages.size()).build())
                .build();
        LinkedMultiValueMap<String, String> query = new LinkedMultiValueMap<>();
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/getMessagesSince")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        SliceOfMessage<MessageDto> slice = objectMapper.readValue(result.getResponse().getContentAsString(), SliceOfMessage.class);
    ...
    void getMessagesSinceWithError() throws Exception {
        //test 400
        GetPrivateMessageSinceRequest request = GetPrivateMessageSinceRequest
                .builder().pageRequest(PageRequest.builder().page(-1).size(0).build())
                .build();
        LinkedMultiValueMap<String, String> query = new LinkedMultiValueMap<>();
        query.add("pageRequest.page", request.getPageRequest().getPage().toString());
        query.add("pageRequest.size", request.getPageRequest().getSize().toString());
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/getMessagesSince")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void create() throws Exception {
        ...
        CreatePrivateChannelRequest request = CreatePrivateChannelRequest.builder().
                targetUserId(otherUser.getId().toString()).build();
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/api/channel/private/create")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(request))
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        PrivateChannelProfile returned = objectMapper.readValue(result.getResponse().getContentAsString(), PrivateChannelProfile.class);
        PrivateChannelProfile real = channelService.getChannelProfile(request.getTargetUserId(), returned.getId());
    ...
    void createWithError() throws Exception {
        ...
        //test 403
        request = CreatePrivateChannelRequest.builder().targetUserId(otherUser.getId().toString()).build();
        for (Throwable e : Arrays.asList(new AlreadyExist(""), new InvalidOperation(""), new UserDoesNotExist(""))) {
            Mockito.doThrow(e).when(channelService)
                    .createChannelBetween(user1.getId().toString(), request.getTargetUserId());
            mockMvc.perform(MockMvcRequestBuilders.post("/api/channel/private/create")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(request))
                            .accept(MediaType.APPLICATION_JSON))
                    .andExpect(jsonPath("$.message").exists())
    ...
    void list() throws Exception {
        ...
        SliceList<PrivateChannelProfile> profiles = channelService.getAllChannels(user1.getId().toString(), request);
        //test success
        LinkedMultiValueMap<String, String> query = new LinkedMultiValueMap<>();
        query.add("page", request.getPage().toString());
        query.add("size", request.getSize().toString());
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/list")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        SliceOfChannel slice = objectMapper.readValue(result.getResponse().getContentAsString(), SliceOfChannel.class);
    ...
    void listWithError() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/list")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.errors.page").exists())
                .andExpect(jsonPath("$.errors.size").exists())
    ...
    void profile() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/profile")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        PrivateChannelProfile returned = objectMapper.readValue(result.getResponse().getContentAsString(), PrivateChannelProfile.class);
        PrivateChannelProfile real = channelService.getChannelProfile(user1.getId().toString(), returned.getId());
        assertEquals(real, returned);
    }
    ...
    void profileWithError() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/channel/private/profile")
                        .params(query)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.errors.channelId").exists())
                .andExpect(status().isBadRequest());
